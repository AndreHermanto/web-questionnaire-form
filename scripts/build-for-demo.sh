...
REACT_APP_BUILD_TIME=`date` REACT_APP_PAYMENTS_URL=/demo/web-payments/develop/# REACT_APP_BASE_URL=https://uat.genome.one/api/gw-questionnaire/v1 CI=true npm run build
mkdir -p $branch_name
cp -R build/* $branch_name
